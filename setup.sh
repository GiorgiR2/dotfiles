...
main(){
	dotFiles=('.aliases' '.fehbg' '.profile' '.selected_editor' '.tmux.conf' '.zshrc' '.newsboat' '.emacs' '.emacs.d/myinit.org' '.config/compton' '.config/i3' '.config/kitty' '.config/nvim' '.config/ranger')
